...
feature_engineer <- function(df) {
  df |>
    mutate(
      ...
      # --- 16. Ratio adultos mayores sobre PET ------------
...
cat("    [07] edad_prom_sq           [16] ratio_mayores_65\n")
cat("    [08] mujeres_x_inact        [17] jefe_mayor_inactivo\n")
cat("    [09] jefe_mujer_inact\n")
